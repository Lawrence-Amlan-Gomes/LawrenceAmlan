    ...
    <div className="h-screen w-full flex justify-center items-center pl-[50px] relative z-0 pr-[50px] pt-[100px] overflow-hidden pb-[20px]">
      <div className="w-full h-full ">
        <motion.div
          ...
          animate={{ x: 1 }}
          className="h-full w-[35%] border-zinc-700 relative border-[1px] overflow-hidden rounded-3xl float-left"
        >
          <Image
            src={Pic}
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, type: "spring" }}
          animate={{ x: 1 }}
          className="h-full w-[60%] ml-[5%] overflow-y-auto text-zinc-300 pr-[10px] float-left scrollbar-thin scrollbar-thumb-black scrollbar-track-zinc-900"
        >
          <motion.div
            initial={{ scale: 1 }}
          ...
          <motion.div
            ...
            whileHover={{ scale: 0.99 }}
            transition={{ duration: 0.5, type: "spring" }}
            className="w-full p-10 mb-[20px] border-[1px] border-zinc-700 rounded-xl bg-zinc-950 lg:text-3xl"
          >
